...
|---|---|
| **Data** | Agosto de 2026 |
| **Escopo** | Verificação e Validação de IA Militar |
| **Formato** | Manual de leitura, 9 capítulos |

## Comece aqui

Este é um documento vivo, atualizado continuamente. Os 9 capítulos cobrem, em ordem:

1. **[Conceitos fundamentais](01-conceitos.md)** — o que conta como alucinação, e por que "confiável" não é o mesmo que "digno de confiança".
